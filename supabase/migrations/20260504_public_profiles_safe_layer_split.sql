...
-- Versao dividida em blocos para rodar no SQL Editor.
-- Rode um bloco por vez.

-- BLOCO 1/3 - Busca segura de atletas publicos
...
-- BLOCO 2/3 - Perfil publico seguro
...
-- BLOCO 3/3 - WhatsApp liberado apenas por match mutuo
