...
export const DEFAULTS_EQUIPE  = ['partidas','var_atleta','solicitacoes_eq','meus_pagamentos','financas_avulso','criar_partida','gerenciar_membros','relatorios_eq','regras_eq','descobrir_atletas','permissoes_eq'];
